...
pkgs: with pkgs; [
    ...
    xlibs.xev
    xorg.xdpyinfo xorg.xkill xorg.xmodmap 
    #sqldeveloper
    ...
    guile hdparm hevm hicolor_icon_theme hipchat hplip htop httpie i3 i3lock i3status icedtea_web iftop imagemagick inkscape iomelt iotop iptables irssi isync iw jackline jitsi jmtpfs jnettop jq kadu keepassx2 konsole kubernetes 
    ...
    vnstat w3m-full watchman wayland weechat weechat-matrix-bridge weechat-xmpp wget which wine wineStaging winetricks wireshark-gtk wmctrl xautolock xclip xdg-user-dirs xdg_utils xdotool xfontsel xidel xlockmore xlsfonts 
